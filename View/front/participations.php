...
$listeEv = $evenementC->afficherEvenementUser($idUser);
                     ...
                     <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <ul class="navbar-nav mr-auto">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="afficherFavoris.php">Favoris</a>
                                 </li>
                              </ul>
                           </div>
                        </nav>
            ...
            <div class="row">
               ...
               <div class="col-md-12 margin_top40">
                  <div class="row d_flex">
                     <div class="col-md-5">
                        <div class="news_img">
                           <figure><img src="images/event.jpg"></figure>
                        </div>
                     </div>
                     <div class="col-md-7">
                        <div class="news_text">
                           <h3><?php echo $ev['nom']; ?></h3>
                           <span><?php echo $ev['dateE']; ?></span> 
                           <div class="date_like">
                              
                           </div>
                           <p>Vous avez reservez une place dans cet évenement intitulé <?php echo $ev['nom']; ?> qui sera le <?php echo $ev['dateE']; ?> à <?php echo $ev['prix']; ?> DT</p>
                        </div>
                     </div>
                  </div>
               </div>
